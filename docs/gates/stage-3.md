...
| Arrest / CPR EtCO2 (engine) | VF without CPR: EtCO2 < 5 mmHg at **+19 s** (limit 30 s). CPR quality 1 (CO ratio 0.31): EtCO2 **21.0, 22.9, 24.1 mmHg** in minutes 1–3 — slowly creeping up as the tissue store fills (prototype band 10–20 was a demo estimate, not an acceptance; see Notes) |
